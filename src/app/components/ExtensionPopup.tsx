          ...
          >
            ...
            <div className="flex flex-wrap gap-2 justify-center">
              {detectedSkills.map((skill, index) => (
                <motion.span key={skill} initial={{ scale: 0 }} animate={{ scale: 1 }} transition={{ duration: 0.3, delay: 0.3 + index * 0.1 }} className="px-3 py-1.5 bg-secondary text-secondary-foreground rounded-full text-xs font-medium">
                  {skill}
                </motion.span>
              ))}
            </div>
